  ...
  <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-head">
              <h2 class="text-center my-5">Purchase Table</h2>
              <div class="supplier-main">
                 <a class="btn btn-primary m-3" href="{{route('add.purchase')}}"><i class="fas fa-plus-circle"></i>Add Purchase</a>
                    ...
                    <thead>
                     ...
                     <tr>
                       ...
                       <td style="display: flex">
                        @if($purchases->status == '0')
                           <a href="{{route('delete.purchase',$purchases->id)}}" id="delete" class="btn btn-danger m-1"><i class="fa-solid fa-pen-to-square"></i></a>
                           @endif
                        </td>
                     </tr>
                     @endforeach
